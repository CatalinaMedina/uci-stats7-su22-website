...
Homework and discussion quizzes will be submitted to Gradescope. Gradescope can be accessed through Canvas. Gradescope upload directions: [`r fontawesome::fa(name = "link", fill = "blue")`](lab-material/submitting_hw_guide.pdf)
